...
class CheckersApp:
    ...
    def on_click(self, event):
        ...
        if self.selected_piece:
            selected_row, selected_col, selected_color = self.pieces[self.selected_piece]
            if clicked_piece:
                return
            ...
            r, c, color = self.pieces[clicked_piece]
            if color == self.turn:
    ...
    def is_valid_move(self, piece_id, new_row, new_col):
        ...
        row, col, color = self.pieces[piece_id]
        dr = new_row - row
        dc = new_col - col
        ...
        if abs(dr) == 2 and abs(dc) == 2:
            ...
            middle_piece = self.get_piece_at(middle_row, middle_col)
            if middle_piece:
                _, _, middle_color = self.pieces[middle_piece]
